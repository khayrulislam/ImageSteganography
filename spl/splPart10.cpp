...
int selectChoise(){
	...
	cout <<"Enter 2 for inserting image into the image."<<endl;
	cout <<"Enter 3 for inserting image into the image."<<endl<<endl;
...
int isMessageEncoded(){
	...
	if((unsigned char)hostPadding[0]==0xff) return 1;
	else if((unsigned char)hostPadding[0] == 0X00) return 2;
...
void invisibleInserting(headerInfo bmpHeaderInfo,headerInfo bmpHeaderInfo2){
	...
	//cout << bmpHeaderInfo2.sizeOfImage<<endl;
	//cout << bmpHeaderInfo2.sizeOfImage*bmpHeaderInfo2.numberOfPixel<<endl;
